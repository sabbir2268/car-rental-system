    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="card w-full max-w-md bg-[var(--card)] shadow-xl border border-[var(--border)] p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {loading ? <span className="loading loading-spinner"></span> : <LogIn size={18} />}
        ...
        <button
          ...
          className="btn w-full btn-outline border-gray-300 text-[var(--foreground)] hover:bg-gray-100"
        >
